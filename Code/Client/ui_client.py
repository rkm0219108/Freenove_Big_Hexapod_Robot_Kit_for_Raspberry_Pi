...
class Ui_client(object):
    def setupUi(self, client):
        ...
        self.Button_Face_Recognition.setGeometry(
            QtCore.QRect(630, 355, 90, 30))
        font = QtGui.QFont()
        font.setFamily("Arial")
    ...
    def retranslateUi(self, client):
        ...
        client.setWindowTitle(_translate(
            "client", "Freenove Client for Hexapod"))
        ...
        self.Button_Face_Recognition.setText(
            _translate("client", "Face Recog"))
